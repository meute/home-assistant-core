...
NETATMO_CREATE_HOME_CLIMATE_PRESET_SELECT = "netatmo_create_home_climate_preset_select"
NETATMO_CREATE_HOME_CLIMATE_SCHEDULE_SELECT = "netatmo_create_home_climate_schedule_select"
